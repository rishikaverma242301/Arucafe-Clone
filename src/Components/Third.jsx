...
const Third = () => {
  return (
    <div className='text-center' data-aos="fade-up">
      <h6 className='text-orange-500 mt-24 mb-4 sm:text-xl'>EXPLORE THE TASTE</h6>
      <h2 className='text-amber-950 text-3xl  sm:text-4xl font-medium mb-8'>Our Flavor Menus</h2>
     
      <div className='grid grid-cols-1 sm:grid-cols-2  gap-10 items-start  h-[120vh] justify-end '>
          ...
          <div className='text-left '>
            <h5 className='text-orange-500 mb-6 text-3xl mt-8'>COFFEE</h5>
